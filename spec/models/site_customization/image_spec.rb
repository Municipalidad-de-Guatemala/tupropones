...
describe SiteCustomization::Image do
  ...
  describe "logo" do
    ...
    it "is valid with a 223x80 image" do
      image = build(:site_customization_image,
                    name: "logo_header",
                    image: fixture_file_upload("logo_header_muniguate.png"))
    ...
    it "dynamically validates the valid images" do
      ...
      custom = build(:site_customization_image, name: "custom", image: fixture_file_upload("logo_header_muniguate.png"))
